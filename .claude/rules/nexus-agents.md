...
This project uses [nexus-agents](https://github.com/williamzujkowski/nexus-agents) v2.4.0 for multi-agent orchestration.
...
---
*Generated by nexus-agents setup v2.4.0*
